...
* 当前 Mod 版本：**v1.14.4**（正式版）
* 支持语言：简体中文 / 繁體中文 / English / Français / Español (AR) / Português (BR)
...
2. 将以下 Mod 放入 `.minecraft/mods/` 文件夹：
   ...
   * Carpet（26.1+ 版本）
   * Fabric API
   * **`[vpl-v1.14.4-for-26.1-26.2]carpet-addition-v1.14.4.jar`**
3. 启动游戏即可。
...
*有可能在26.1 26.1.1 26.1.2版本中会崩，26.2应该可能好像暂时没什么问题
